...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../../algorithms" /I "../../inc" /I "../../inc/serialization" /I "$(GDAL_HOME)/include" /I "$(GSL_HOME)/include" /D "_WINDOWS" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_USRDLL" /D "OM_CSMKG_EXPORTS" /D "CORE_DLL_IMPORT" /YX /FD /c
