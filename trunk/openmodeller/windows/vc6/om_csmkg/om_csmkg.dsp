...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../../algorithms" /I "../../inc" /I "../../inc/env_io" /I "$(GDAL_HOME)/include" /I "$(GSL_HOME)/include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OM_CSMKG_EXPORTS" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "../../algorithms" /I "../../inc" /I "../../inc/env_io" /I "$(GDAL_HOME)/include" /I "$(GSL_HOME)/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "OM_CSMKG_EXPORTS" /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib  libexpat.lib gdal_i.lib libopenmodeller.lib gslMT.lib gslcblasMT.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"scew_d.lib" /pdbtype:sept /libpath:"$(GDAL_HOME)\lib" /libpath:"../build_debug/lib" /libpath:"$(EXPAT_HOME)/libs" /libpath:"$(GSL_HOME)/lib"
# Begin Special Build Tool
TargetDir=.\Debug
TargetName=om_csmkg
SOURCE="$(InputPath)"
