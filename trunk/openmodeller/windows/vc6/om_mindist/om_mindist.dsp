...
TargetPath=.\Release\om_mindist.dll
SOURCE="$(InputPath)"
...
# ADD LINK32 gdal_i.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept /libpath:"$(GDAL_DIR)/lib" /libpath:"$(GDAL_HOME)\lib"
