...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../../algorithms" /I "../../inc" /I "../../inc/serialization" /I "$(GDAL_HOME)/include" /I "$(JAVA_HOME)/include" /I "$(JAVA_HOME)/bin" /D "_WINDOWS" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_USRDLL" /D "OM_DISTANCE_TO_AVERAGE_EXPORTS" /D "CORE_DLL_IMPORT" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "../../algorithms" /I "../../inc" /I "../../inc/serialization" /I "$(GDAL_HOME)/include" /D "_WINDOWS" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_USRDLL" /D "OM_DISTANCE_TO_AVERAGE_EXPORTS" /D "CORE_DLL_IMPORT" /YX /FD /GZ /c
...
SOURCE=..\..\..\algorithms\distance_to_average.hh
# End Source File
# End Group
