...
CxxTest::StaticSuiteDescription suiteDescription_test_Jackknife( "pre_test_jackknife.hh", 52, "test_Jackknife", suite_test_Jackknife, Tests_test_Jackknife );

static class TestDescription_test_Jackknife_test1 : public CxxTest::RealTestDescription {
public:
 TestDescription_test_Jackknife_test1() : CxxTest::RealTestDescription( Tests_test_Jackknife, suiteDescription_test_Jackknife, 62, "test1" ) {}
