...
SOAP_SOURCE_STAMP("@(#) soapClient.cpp ver 2.8.15 2013-05-17 12:35:55 GMT")
...
{	struct omws__getLayerAsAttachment soap_tmp_omws__getLayerAsAttachment;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_omws__getLayerAsAttachment(soap, &soap_tmp_omws__getLayerAsAttachment, "omws:getLayerAsAttachment", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (!soap_tmp_omws__getLayerAsAttachmentResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__getLayerAsWcs soap_tmp_omws__getLayerAsWcs;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_omws__getLayerAsWcs(soap, &soap_tmp_omws__getLayerAsWcs, "omws:getLayerAsWcs", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (!soap_tmp_omws__getLayerAsWcsResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
