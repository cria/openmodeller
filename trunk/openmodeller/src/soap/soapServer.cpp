...
SOAP_SOURCE_STAMP("@(#) soapServer.cpp ver 2.8.9 2012-08-02 19:40:26 GMT")
...
{	struct omws__getLayerAsAttachment soap_tmp_omws__getLayerAsAttachment;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_omws__getLayerAsAttachmentResponse(soap, &soap_tmp_omws__getLayerAsAttachmentResponse, "omws:getLayerAsAttachmentResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct omws__getLayerAsWcs soap_tmp_omws__getLayerAsWcs;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_omws__getLayerAsWcsResponse(soap, &soap_tmp_omws__getLayerAsWcsResponse, "omws:getLayerAsWcsResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
