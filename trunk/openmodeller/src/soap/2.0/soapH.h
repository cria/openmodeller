...
inline struct omws__getProgressResponse * soap_new_req_omws__getProgressResponse(struct soap *soap, char *progress) { struct omws__getProgressResponse *_p = soap_instantiate_omws__getProgressResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_omws__getProgressResponse(soap, _p); _p->progress = progress; } return _p; }

inline struct omws__getProgressResponse * soap_new_set_omws__getProgressResponse(struct soap *soap, char *progress) { struct omws__getProgressResponse *_p = soap_instantiate_omws__getProgressResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_omws__getProgressResponse(soap, _p); _p->progress = progress; } return _p; }
