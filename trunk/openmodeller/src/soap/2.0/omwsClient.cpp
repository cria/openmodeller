...
SOAP_SOURCE_STAMP("@(#) omwsClient.cpp ver 2.8.15 2013-08-03 00:37:13 GMT")
...
{	struct omws__ping soap_tmp_omws__ping;
	...
	if (!soap_tmp_omws__pingResponse || soap->error)
...
{	struct omws__createModel soap_tmp_omws__createModel;
	...
	if (!&ticket)
		return soap_closesock(soap);
	soap_default_xsd__string(soap, &ticket);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
	...
	if (!soap_tmp_omws__createModelResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__testModel soap_tmp_omws__testModel;
	...
	if (!soap_tmp_omws__testModelResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__projectModel soap_tmp_omws__projectModel;
	...
	if (!soap_tmp_omws__projectModelResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__getProgress soap_tmp_omws__getProgress;
	...
	if (!&progress)
		return soap_closesock(soap);
	soap_default_xsd__string(soap, &progress);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
	...
	if (!soap_tmp_omws__getProgressResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__getLog soap_tmp_omws__getLog;
	...
	if (!&log)
		return soap_closesock(soap);
	soap_default_xsd__string(soap, &log);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
	...
	if (!soap_tmp_omws__getLogResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__getLayerAsUrl soap_tmp_omws__getLayerAsUrl;
	...
	if (!&url)
		return soap_closesock(soap);
	soap_default_xsd__string(soap, &url);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
	...
	if (!soap_tmp_omws__getLayerAsUrlResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__evaluateModel soap_tmp_omws__evaluateModel;
	...
	if (!soap_tmp_omws__evaluateModelResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__samplePoints soap_tmp_omws__samplePoints;
	...
	if (!soap_tmp_omws__samplePointsResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
...
{	struct omws__cancel soap_tmp_omws__cancel;
	...
	if (!&cancelledTickets)
		return soap_closesock(soap);
	soap_default_xsd__string(soap, &cancelledTickets);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
	...
	if (!soap_tmp_omws__cancelResponse || soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
