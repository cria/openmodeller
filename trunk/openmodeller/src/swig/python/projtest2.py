...
print "Creating output map.        \n\n", mod.createMap(mod.getEnvironment(), "map.tif", "mask", 255);
...
print "Creating projection map (elevation):\n\n ", mod.createMap(projenv1, "elevproj.tif", "mask", 255);
print "Creating projection map (climate):\n\n   ", mod.createMap(projenv2, "climproj.tif", "mask", 255);
