...
#include "om_test_jackknife.h"

static test_Jackknife suite_test_Jackknife;

static CxxTest::List Tests_test_Jackknife = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_test_Jackknife( "om_test_jackknife.h", 54, "test_Jackknife", suite_test_Jackknife, Tests_test_Jackknife );
