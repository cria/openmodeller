...
class InstanceSet {
    public:
        ...
        static InstanceSet* load_unsupervised(const string& data,
                                              ...
                                              bool header = false,
                                              const string& delim =",");
        static InstanceSet* load_unsupervised(istream& in,
                                              unsigned int * seed,
                                              bool header = false,
                                              const string& delim =",");
        ...
        static InstanceSet* load_csv_and_labels(const string& data,
                                                    ...
                                                    bool header = false,
                                                    const string& delim =",");
        static InstanceSet* load_csv_and_labels(istream& data,
                                                    istream& labels,
                                                    bool header = false,
                                                    const string& delim =",");
    ...
    private:
        ...
        InstanceSet(istream& sdata, istream& slabels,
                    bool header=false, const string& delim=",");
        // Load csv for unsupervised
        InstanceSet(istream& in, unsigned int* seed,
                    bool header=false, const string& delim=",");
