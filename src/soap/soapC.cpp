...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.9 2012-08-02 19:40:26 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_omws__getLayerAsAttachment:
		return (void*)soap_instantiate_omws__getLayerAsAttachment(soap, -1, type, arrayType, n);
	case SOAP_TYPE_omws__getLayerAsUrlResponse:
	...
	case SOAP_TYPE_omws__getLayerAsWcsResponse:
		return (void*)soap_instantiate_omws__getLayerAsWcsResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_omws__getLayerAsWcs:
		return (void*)soap_instantiate_omws__getLayerAsWcs(soap, -1, type, arrayType, n);
	case SOAP_TYPE_omws__getProjectionMetadataResponse:
...
{	switch (p->type)
	...
	case SOAP_TYPE_omws__getLayerAsAttachmentResponse:
		if (p->size < 0)
			SOAP_DELETE((struct omws__getLayerAsAttachmentResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct omws__getLayerAsAttachmentResponse*)p->ptr);
		break;
	case SOAP_TYPE_omws__getLayerAsAttachment:
		if (p->size < 0)
			SOAP_DELETE((struct omws__getLayerAsAttachment*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct omws__getLayerAsAttachment*)p->ptr);
		break;
	case SOAP_TYPE_omws__getLayerAsUrlResponse:
		if (p->size < 0)
	...
	case SOAP_TYPE_omws__getLayerAsWcsResponse:
		if (p->size < 0)
			SOAP_DELETE((struct omws__getLayerAsWcsResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct omws__getLayerAsWcsResponse*)p->ptr);
		break;
	case SOAP_TYPE_omws__getLayerAsWcs:
		if (p->size < 0)
			SOAP_DELETE((struct omws__getLayerAsWcs*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct omws__getLayerAsWcs*)p->ptr);
		break;
	case SOAP_TYPE_omws__getProjectionMetadataResponse:
		if (p->size < 0)
...
SOAP_FMAC1 struct omws__getProjectionMetadata * SOAP_FMAC2 soap_instantiate_omws__getProjectionMetadata(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getProjectionMetadata[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getProjectionMetadataResponse * SOAP_FMAC2 soap_instantiate_omws__getProjectionMetadataResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getProjectionMetadataResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_omws__getLayerAsWcs), type))
		return soap->error;
...
SOAP_FMAC3 struct omws__getLayerAsWcs * SOAP_FMAC4 soap_in_omws__getLayerAsWcs(struct soap *soap, const char *tag, struct omws__getLayerAsWcs *a, const char *type)
{
	...
	{	a = (struct omws__getLayerAsWcs *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_omws__getLayerAsWcs, 0, sizeof(struct omws__getLayerAsWcs), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_omws__getLayerAsWcs(struct soap *soap, const struct omws__getLayerAsWcs *a, const char *tag, const char *type)
{
	...
	if (soap_out_omws__getLayerAsWcs(soap, tag?tag:"omws:getLayerAsWcs", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 struct omws__getLayerAsWcs * SOAP_FMAC2 soap_instantiate_omws__getLayerAsWcs(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_omws__getLayerAsWcs(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_omws__getLayerAsWcs, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsWcs);
		if (size)
			*size = sizeof(struct omws__getLayerAsWcs);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsWcs[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct omws__getLayerAsWcs);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct omws__getLayerAsWcs*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_omws__getLayerAsWcs(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct omws__getLayerAsWcs %p -> %p\n", q, p));
	*(struct omws__getLayerAsWcs*)p = *(struct omws__getLayerAsWcs*)q;
}
...
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_omws__getLayerAsWcsResponse), type))
		return soap->error;
	if (a->url)
...
SOAP_FMAC3 struct omws__getLayerAsWcsResponse * SOAP_FMAC4 soap_in_omws__getLayerAsWcsResponse(struct soap *soap, const char *tag, struct omws__getLayerAsWcsResponse *a, const char *type)
{
	...
	{	a = (struct omws__getLayerAsWcsResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_omws__getLayerAsWcsResponse, 0, sizeof(struct omws__getLayerAsWcsResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_omws__getLayerAsWcsResponse(struct soap *soap, const struct omws__getLayerAsWcsResponse *a, const char *tag, const char *type)
{
	...
	if (soap_out_omws__getLayerAsWcsResponse(soap, tag?tag:"omws:getLayerAsWcsResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 struct omws__getLayerAsWcsResponse * SOAP_FMAC2 soap_instantiate_omws__getLayerAsWcsResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_omws__getLayerAsWcsResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_omws__getLayerAsWcsResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsWcsResponse);
		if (size)
			*size = sizeof(struct omws__getLayerAsWcsResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsWcsResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct omws__getLayerAsWcsResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct omws__getLayerAsWcsResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_omws__getLayerAsWcsResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct omws__getLayerAsWcsResponse %p -> %p\n", q, p));
	*(struct omws__getLayerAsWcsResponse*)p = *(struct omws__getLayerAsWcsResponse*)q;
}
...
SOAP_FMAC1 struct omws__getLayerAsUrl * SOAP_FMAC2 soap_instantiate_omws__getLayerAsUrl(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsUrl[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getLayerAsUrlResponse * SOAP_FMAC2 soap_instantiate_omws__getLayerAsUrlResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsUrlResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_omws__getLayerAsAttachment), type))
		return soap->error;
	if (soap_out_xsd__string(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 struct omws__getLayerAsAttachment * SOAP_FMAC4 soap_in_omws__getLayerAsAttachment(struct soap *soap, const char *tag, struct omws__getLayerAsAttachment *a, const char *type)
{
	...
	{	a = (struct omws__getLayerAsAttachment *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_omws__getLayerAsAttachment, 0, sizeof(struct omws__getLayerAsAttachment), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_omws__getLayerAsAttachment(struct soap *soap, const struct omws__getLayerAsAttachment *a, const char *tag, const char *type)
{
	...
	if (soap_out_omws__getLayerAsAttachment(soap, tag?tag:"omws:getLayerAsAttachment", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 struct omws__getLayerAsAttachment * SOAP_FMAC2 soap_instantiate_omws__getLayerAsAttachment(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_omws__getLayerAsAttachment(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_omws__getLayerAsAttachment, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsAttachment);
		if (size)
			*size = sizeof(struct omws__getLayerAsAttachment);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsAttachment[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
		if (size)
			*size = n * sizeof(struct omws__getLayerAsAttachment);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	return (struct omws__getLayerAsAttachment*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_omws__getLayerAsAttachment(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct omws__getLayerAsAttachment %p -> %p\n", q, p));
	*(struct omws__getLayerAsAttachment*)p = *(struct omws__getLayerAsAttachment*)q;
}
...
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_omws__getLayerAsAttachmentResponse), type))
		return soap->error;
...
SOAP_FMAC3 struct omws__getLayerAsAttachmentResponse * SOAP_FMAC4 soap_in_omws__getLayerAsAttachmentResponse(struct soap *soap, const char *tag, struct omws__getLayerAsAttachmentResponse *a, const char *type)
{
	...
	{	a = (struct omws__getLayerAsAttachmentResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_omws__getLayerAsAttachmentResponse, 0, sizeof(struct omws__getLayerAsAttachmentResponse), 0, soap_copy_omws__getLayerAsAttachmentResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_omws__getLayerAsAttachmentResponse(struct soap *soap, const struct omws__getLayerAsAttachmentResponse *a, const char *tag, const char *type)
{
	...
	if (soap_out_omws__getLayerAsAttachmentResponse(soap, tag?tag:"omws:getLayerAsAttachmentResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 struct omws__getLayerAsAttachmentResponse * SOAP_FMAC2 soap_instantiate_omws__getLayerAsAttachmentResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsAttachmentResponse);
		if (size)
			*size = sizeof(struct omws__getLayerAsAttachmentResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayerAsAttachmentResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_copy_omws__getLayerAsAttachmentResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
...
SOAP_FMAC1 struct omws__getLog * SOAP_FMAC2 soap_instantiate_omws__getLog(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLog[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getLogResponse * SOAP_FMAC2 soap_instantiate_omws__getLogResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLogResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getProgress * SOAP_FMAC2 soap_instantiate_omws__getProgress(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getProgress[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_omws__getProgressResponse(struct soap *soap, const char *tag, int id, const struct omws__getProgressResponse *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_omws__getProgressResponse), type))
		return soap->error;
	if (soap_out_xsd__int(soap, "progress", -1, &a->progress, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC1 struct omws__getProgressResponse * SOAP_FMAC2 soap_instantiate_omws__getProgressResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getProgressResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__projectModel * SOAP_FMAC2 soap_instantiate_omws__projectModel(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__projectModel[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__projectModelResponse * SOAP_FMAC2 soap_instantiate_omws__projectModelResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__projectModelResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getTestResult * SOAP_FMAC2 soap_instantiate_omws__getTestResult(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getTestResult[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__testResponse * SOAP_FMAC2 soap_instantiate_omws__testResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__testResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__testModel * SOAP_FMAC2 soap_instantiate_omws__testModel(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__testModel[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__testModelResponse * SOAP_FMAC2 soap_instantiate_omws__testModelResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__testModelResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getModel * SOAP_FMAC2 soap_instantiate_omws__getModel(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getModel[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getModelResponse * SOAP_FMAC2 soap_instantiate_omws__getModelResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getModelResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__createModel * SOAP_FMAC2 soap_instantiate_omws__createModel(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__createModel[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__createModelResponse * SOAP_FMAC2 soap_instantiate_omws__createModelResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__createModelResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getLayers * SOAP_FMAC2 soap_instantiate_omws__getLayers(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayers[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getLayersResponse * SOAP_FMAC2 soap_instantiate_omws__getLayersResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getLayersResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getAlgorithms * SOAP_FMAC2 soap_instantiate_omws__getAlgorithms(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getAlgorithms[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__getAlgorithmsResponse * SOAP_FMAC2 soap_instantiate_omws__getAlgorithmsResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__getAlgorithmsResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__ping * SOAP_FMAC2 soap_instantiate_omws__ping(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__ping[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC1 struct omws__pingResponse * SOAP_FMAC2 soap_instantiate_omws__pingResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	{	cp->ptr = (void*)SOAP_NEW(struct omws__pingResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 struct omws__getProjectionMetadataResponse ** SOAP_FMAC4 soap_in_PointerToomws__getProjectionMetadataResponse(struct soap *soap, const char *tag, struct omws__getProjectionMetadataResponse **a, const char *type)
{
	...
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		*a = (struct omws__getProjectionMetadataResponse *)soap_malloc(soap, sizeof(struct omws__getProjectionMetadataResponse));
		soap_default_omws__getProjectionMetadataResponse(soap, *a);
...
SOAP_FMAC3 struct omws__testResponse ** SOAP_FMAC4 soap_in_PointerToomws__testResponse(struct soap *soap, const char *tag, struct omws__testResponse **a, const char *type)
{
	...
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		*a = (struct omws__testResponse *)soap_malloc(soap, sizeof(struct omws__testResponse));
		soap_default_omws__testResponse(soap, *a);
...
SOAP_FMAC3 struct omws__getModelResponse ** SOAP_FMAC4 soap_in_PointerToomws__getModelResponse(struct soap *soap, const char *tag, struct omws__getModelResponse **a, const char *type)
{
	...
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		*a = (struct omws__getModelResponse *)soap_malloc(soap, sizeof(struct omws__getModelResponse));
		soap_default_omws__getModelResponse(soap, *a);
...
SOAP_FMAC3 struct omws__getLayersResponse ** SOAP_FMAC4 soap_in_PointerToomws__getLayersResponse(struct soap *soap, const char *tag, struct omws__getLayersResponse **a, const char *type)
{
	...
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		*a = (struct omws__getLayersResponse *)soap_malloc(soap, sizeof(struct omws__getLayersResponse));
		soap_default_omws__getLayersResponse(soap, *a);
...
SOAP_FMAC3 struct omws__getAlgorithmsResponse ** SOAP_FMAC4 soap_in_PointerToomws__getAlgorithmsResponse(struct soap *soap, const char *tag, struct omws__getAlgorithmsResponse **a, const char *type)
{
	...
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		*a = (struct omws__getAlgorithmsResponse *)soap_malloc(soap, sizeof(struct omws__getAlgorithmsResponse));
		soap_default_omws__getAlgorithmsResponse(soap, *a);
